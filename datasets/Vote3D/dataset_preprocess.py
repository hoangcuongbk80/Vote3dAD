...
import datasets.Vote3D.transform as aug_transform
import re
...
class Dataset:
    def __init__(self, cfg):
        ...
        data_list = glob.glob("datasets/Vote3D/Vote3D-AD-PLY/{}/*.ply".format(self.category))
        ...
        self.test_file_list = glob.glob("datasets/Vote3D/Vote3D-AD/{}/test/*.pcd".format(self.category))
    ...
    def testMerge(self, id):
        ...
        for i, idx in enumerate(id):
            ...
            if 'good' in fn_path:
                ...
                gt_mask_path = f'datasets/Vote3D/Vote3D-AD/{self.category}/gt/'
